...
def UpdateDefenderDF(shot, team, defense):
    ...
    defender_file['ovr_data']['shooting_locations'].append(((x, y), shot['result'], shot['full_play_type']))
    ...
    defender_file[f'{shot["shot_zone"]}']['shooting_locations'].append(((x, y), shot['result'], shot['full_play_type']))
