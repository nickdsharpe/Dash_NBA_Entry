...
def UpdateCreatorDF(shot, team):
    ...
    player_shot_zone_file['created_locations'].append(((x, y), shot['result']))
    ...
    team_shot_zone_file['created_locations'].append(((x, y), shot['result']))
    ...
    player_overall_file['created_locations'].append(((x, y), shot['result']))
    ...
    team_overall_file['created_locations'].append(((x, y), shot['result']))
